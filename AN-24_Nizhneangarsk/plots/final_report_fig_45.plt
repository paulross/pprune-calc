...
set grid
set title "Distance From Runway Start. From Figure 45."
...
set output "images/final_report_fig_45.svg"   # choose the output device

plot "data/final_report_fig_45.dat" using 1:8:9:10 title "Distance error (m)" w yerrorbars #, \
    "data/final_report_fig_45.dat" using 1:(mid_error($2)) title "Fitted to mid values" lw 2 w line

set terminal png size 600,400           # choose the file format
set output "images/final_report_fig_45.png"   # choose the output device
