...
set grid
set title "Distance From Runway Start. From Figure 48."
...
set output "images/final_report_fig_48.svg"   # choose the output device

plot "data/final_report_fig_48.dat" using 1:8:9:10 title "Distance error (m)" w yerrorbars #, \
...
set output "images/final_report_fig_48.png"   # choose the output device
