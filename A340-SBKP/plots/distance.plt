...
set arrow from 17.800,2201.514 to 27.800,2201.514 lt 3
set label "1915m" at 16.8,1915.3 right font ",10"
set label "2058m" at 16.8,2058.4 right font ",10"
set label "2202m" at 16.8,2201.5 right font ",10"
# End video
set arrow from 35.667,1500 to 35.667,2350 lt -1
set label "End video 35.7s" at 35.7,1400 center font ",10"
set arrow from 25.667,2609.142 to 35.667,2609.142 lt 1
set arrow from 25.667,2792.744 to 35.667,2792.744 lt 2
set arrow from 25.667,2976.347 to 35.667,2976.347 lt 3
set label "2609m" at 24.7,2609.1 right font ",10"
set label "2793m" at 24.7,2792.7 right font ",10"
set label "2976m" at 24.7,2976.3 right font ",10"
