...
set arrow from -30.059,1000 to -30.059,537.140 lt 1
set arrow from -32.829,1200 to -32.829,232.350 lt 2
set arrow from -35.569,1400 to -35.569,-86.615 lt 3
...
# Labels at t=0
set arrow from 6.000,1324.6 to 0.0,1324.608 lt 1
set label "t=0.0s, d=1325m" at 6.0,1324.6 left font ",9"
set arrow from 6.000,1181.6 to 0.0,1181.593 lt 2
set label "t=0.0s, d=1182m" at 6.0,1181.6 left font ",9"
set arrow from 6.000,1038.6 to 0.0,1038.577 lt 3
set label "t=0.0s, d=1039m" at 6.0,1038.6 left font ",9"
# End labels at t=0
